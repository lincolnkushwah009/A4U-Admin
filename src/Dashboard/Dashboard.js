...
import CreateArchitectAndRepresentative from './Users/CreateArchitectAndRepresentative '
import Package from './Users/CreatePackage'
    ...
    return (
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                   <Navbar/>
                        <Route exact path="/dashboard/layout" component={Layout} />
                        <Route exact path="/dashboard/users" component={Users} />
                        <Route exact path="/dashboard/lobby" component={Lobby} />
                        <Route exact path="/dashboard/vip" component={VIP} />
                        <Route exact path="/dashboard/create" component={CreateArchitectAndRepresentative} />
